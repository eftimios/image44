...
TASK_ID="4bc8d380-cdcf-470c-b06d-114d4bd437ca"
...
DATASET_ZIP="https://huggingface.co/datasets/harry1203/training-data/resolve/main/tourn_4e1b54957c766afb_20260226/4bc8d380-cdcf-470c-b06d-114d4bd437ca/training_data.zip"

# Model type: "sdxl" or "flux"
MODEL_TYPE="sdxl"

# Optional: Repository name for the trained model
EXPECTED_REPO_NAME="test-Fluently-XL-Final-2"
